...
pub fn log_drop_counters(drop_counters: &crate::ebpf_loader::DropCountersSnapshot) {
    ...
    log::warn!(
        "ebpf_drop_counters cumulative_total={} wakeup_data_insert_failed={} ringbuf_reserve_failed={} irq_start_times_insert_failed={} block_start_insert_failed={} block_fallback_key_collisions={} block_zero_keys={}",
        drop_counters.total(),
