...
mod tests {
    ...
    fn scenario_create_parses() {
        ...
        let AppCommand::Scenario(scenario_input) = command else {
            panic!("expected Scenario command");
        };
        let crate::commands::input::ScenarioCommand::Create(input) = scenario_input.command else {
    ...
    fn scenario_run_parses_baseline() {
        ...
        let crate::commands::input::ScenarioCommand::Run(input) = scenario_input.command else {
    ...
    fn scenario_compare_parses() {
        ...
        let crate::commands::input::ScenarioCommand::Compare(input) = scenario_input.command else {
    ...
    fn scenario_path_parses() {
        ...
        let crate::commands::input::ScenarioCommand::Path(input) = scenario_input.command else {
