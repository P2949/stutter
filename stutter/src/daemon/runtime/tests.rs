...
use crate::{
    ...
    daemon::{
        ...
        state::{
            DAEMON_STATE_SCHEMA_VERSION, DaemonExperimentState, DaemonPhase, DaemonRollbackState,
        },
    },
...
fn daemon_runtime_lifecycle_resume_pauses_and_marks_health_stabilizing() {
    ...
    let transition =
        runtime.handle_lifecycle_event(DaemonLifecycleEvent::ResumeDetected { slept_ms: 8_000 });
