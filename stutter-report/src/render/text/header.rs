...
pub fn render_header(summary: &ReportHeaderSummary) -> String {
    ...
    pushln(
        &mut output,
        format!("schema: {}", summary.schema_version),
    );
    pushln(
        &mut output,
    ...
    pushln(
        &mut output,
        format!("run: {}", summary.run_name),
    );
    pushln(
        &mut output,
        format!("duration_ms: {}", summary.duration_ms),
    );
    ...
    pushln(
        &mut output,
        format!("tree_roots: {:?}", summary.tree_roots),
    );
    pushln(
        &mut output,
    ...
    pushln(
        &mut output,
        format!("persistent: {}", summary.persistent),
    );
    pushln(
        &mut output,
        format!("csv_stream: {}", summary.csv_stream),
    );
    pushln(
        &mut output,
